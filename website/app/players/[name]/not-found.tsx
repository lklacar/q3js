  ...
  return (
    <div className="min-h-screen bg-background text-foreground">
      ...
      <main className="mx-auto grid min-h-[60vh] w-full max-w-5xl place-items-center px-4 py-16 text-center">
        <div>
          <p className="font-mono text-xs uppercase tracking-[0.16em] text-primary">404 · Player not found</p>
          <h1 className="mt-3 text-3xl font-bold">No reported events for that player.</h1>
